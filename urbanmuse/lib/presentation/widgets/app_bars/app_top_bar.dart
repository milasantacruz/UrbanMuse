...
/// AppMapBar
/// 
/// App Bar especializado para la página del mapa.
/// Transparente con búsqueda y filtros flotantes.
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.fromLTRB(
        ...
        MediaQuery.of(context).padding.top + AppSpacing.space2, // SafeArea + 8px
        AppSpacing.space4, // 16px
